...
<body>
    <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-slate-900 border-r border-slate-700">
        ...
        <div class="flex flex-col justify-between flex-1 mt-10">
            <nav class="space-y-2">
                <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Staff Menu</p>
                ...
                <!-- Histori Pesanan -->
                <a href="#" class="flex items-center px-3 py-2.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-all group">
                    <i class="fas fa-receipt w-5 group-hover:text-amber-500"></i>
            ...
            <div class="mt-auto pt-6 border-t border-slate-800 space-y-2">
                ...
                <button class="flex items-center w-full px-3 py-2.5 text-slate-400 hover:text-white transition-all">
                    ...
                    <span class="mx-3 font-medium">Light/Dark Mode</span>
                </button>
