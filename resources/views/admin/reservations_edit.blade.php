...
<head>
    ...
    <title>GrandStay - Edit Reservasi</title>
...
<body class="bg-slate-950 text-slate-100 min-h-screen font-sans antialiased transition-colors duration-300 dark:bg-slate-950 light:bg-gray-50 light:text-slate-800">
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64 p-8 lg:p-10 overflow-y-auto">
            <div class="mb-8">
                <h1 class="text-3xl font-bold tracking-tight text-white dark:text-white light:text-slate-900">Edit Reservasi</h1>
                <p class="text-sm text-slate-400 dark:text-slate-400 light:text-gray-500 mt-1">Update data reservasi tamu secara manual dengan sistem kalkulasi biaya otomatis.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form id="formReservasi" action="{{ route('reservation.update', $reservation->id) }}" method="POST" class="lg:col-span-2 space-y-6 bg-slate-900 border border-slate-800 dark:bg-slate-900 dark:border-slate-800 light:bg-white light:border-gray-200 p-6 rounded-2xl shadow-sm">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="customer_name" value="{{ $reservation->customer_name }}" required class="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white light:bg-gray-50 light:border-gray-300 light:text-slate-900" placeholder="Nama Lengkap Tamu">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="phone" value="{{ $reservation->phone }}" required class="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white light:bg-gray-50 light:border-gray-300 light:text-slate-900" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <select name="room_ids[]" multiple size="3" class="room-selector w-full p-2 bg-slate-800 border border-slate-700 text-white text-sm rounded-lg outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white light:bg-gray-50 light:border-gray-300 light:text-slate-900 overflow-y-auto scrollbar-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                                    ...
                                    <option value="{{ $room->id }}" data-price="{{ $type->price }}" {{ in_array($room->id, $reservation->rooms->pluck('id')->toArray()) ? 'selected' : '' }} class="py-1 px-2 checked:bg-amber-500 checked:text-slate-900 cursor-pointer rounded mb-0.5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="check_in" id="tglCheckIn" required value="{{$reservation->check_in}}" class="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white light:bg-gray-50 light:border-gray-300 light:text-slate-900 cursor-pointer">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="check_out" id="tglCheckOut" required value="{{$reservation->check_out}}" class="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white light:bg-gray-50 light:border-gray-300 light:text-slate-900 cursor-pointer">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gradient-to-br from-slate-900 to-slate-850 border border-slate-800 p-6 rounded-2xl shadow-xl h-fit sticky top-28 dark:from-slate-900 dark:to-slate-850 dark:border-slate-800 light:from-white light:to-gray-50 light:border-gray-200">
                    ...
                    <button type="submit" form="formReservasi" class="w-full bg-amber-500 hover:bg-amber-600 text-slate-900 font-extrabold py-3.5 rounded-xl mt-6 shadow-lg shadow-amber-500/10 transform transition active:scale-[0.97] flex items-center justify-center gap-2">
                        <i class="fas fa-calendar-check"></i> Update Reservasi
                    </button>
                </div>
